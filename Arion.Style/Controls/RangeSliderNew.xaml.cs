...
{
    public partial class RangeSliderNew
    {
        #region Events
        ...
        public static readonly DependencyProperty UpperValueProperty =
            DependencyProperty.Register(nameof(UpperValue), typeof(double), typeof(RangeSliderNew),
        ...
        public double LowerValue
        {
            ...
            set
            {
                ...
                var v1 = LowerValue * Track.Width;
                var v2 = v1 / Maximum;
                var left = v2 - Minimum;
                Debug.WriteLine($"{v1}, {v2}, {left}");
                LeftThumbMargin = new Thickness(Math.Round(left),0,5,0);
                LeftValueChanged?.Invoke(this, EventArgs.Empty);
            }
        }

        public static readonly DependencyProperty LowerValueProperty =
            DependencyProperty.Register(nameof(LowerValue), typeof(double), typeof(RangeSliderNew), new PropertyMetadata());
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(RangeSliderNew), new PropertyMetadata());
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(RangeSliderNew), new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbMarginProperty =
            DependencyProperty.Register(nameof(LeftThumbMargin), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbBorderProperty =
            DependencyProperty.Register(nameof(LeftThumbBorder), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbBackgroundProperty =
            DependencyProperty.Register(nameof(LeftThumbBackground), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbBorderBrushProperty =
            DependencyProperty.Register(nameof(LeftThumbBorderBrush), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbWidthProperty =
            DependencyProperty.Register(nameof(LeftThumbWidth), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty LeftThumbHeightProperty =
            DependencyProperty.Register(nameof(LeftThumbHeight), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbMarginProperty =
            DependencyProperty.Register(nameof(RightThumbMargin), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbBorderProperty =
            DependencyProperty.Register(nameof(RightThumbBorder), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbBackgroundProperty =
            DependencyProperty.Register(nameof(RightThumbBackground), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbBorderBrushProperty =
            DependencyProperty.Register(nameof(RightThumbBorderBrush), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbWidthProperty =
            DependencyProperty.Register(nameof(RightThumbWidth), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty RightThumbHeightProperty =
            DependencyProperty.Register(nameof(RightThumbHeight), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty CenterMarginProperty =
            DependencyProperty.Register(nameof(CenterMargin), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty PercentProperty =
            DependencyProperty.Register(nameof(Percent), typeof(double), typeof(RangeSliderNew), new PropertyMetadata(.8));
        ...
        public static readonly DependencyProperty CenterThumbWidthProperty =
            DependencyProperty.Register(nameof(CenterThumbWidth), typeof(double), typeof(RangeSliderNew),
        ...
        public static readonly DependencyProperty CenterThumbVisibilityProperty =
            DependencyProperty.Register(nameof(CenterThumbVisibility), typeof(Visibility), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty CenterThumbBackgroundProperty =
            DependencyProperty.Register(nameof(CenterThumbBackground), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty CenterThumbBorderBrushProperty =
            DependencyProperty.Register(nameof(CenterThumbBorderBrush), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty CenterThumbBorderProperty =
            DependencyProperty.Register(nameof(CenterThumbBorder), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty CenterThumbOpacityProperty = DependencyProperty.Register(
            nameof(CenterThumbOpacity), typeof(double), typeof(RangeSliderNew), new PropertyMetadata(default(double)));
        ...
        public static readonly DependencyProperty TrackBackgroundProperty =
            DependencyProperty.Register(nameof(TrackBackground), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty TrackBorderBrushProperty =
            DependencyProperty.Register(nameof(TrackBorderBrush), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty TrackBorderProperty =
            DependencyProperty.Register(nameof(TrackBorder), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty TrackHeightProperty =
            DependencyProperty.Register(nameof(TrackHeight), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty TrackWidthProperty =
            DependencyProperty.Register(nameof(TrackWidth), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty SelectedTrackBackgroundProperty =
            DependencyProperty.Register(nameof(SelectedTrackBackground), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty SelectedTrackBorderBrushProperty =
            DependencyProperty.Register(nameof(SelectedTrackBorderBrush), typeof(SolidColorBrush), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty SelectedTrackBorderProperty =
            DependencyProperty.Register(nameof(SelectedTrackBorder), typeof(Thickness), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty SelectedTrackHeightProperty =
            DependencyProperty.Register(nameof(SelectedTrackHeight), typeof(double), typeof(RangeSliderNew),
                new PropertyMetadata());
        ...
        public static readonly DependencyProperty ShowValuesProperty = DependencyProperty.Register(
            nameof(ShowValues), typeof(bool), typeof(RangeSliderNew), new PropertyMetadata(default(bool)));
        ...
        private void UIElement_OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                _leftSliderPoint = Math.Round(e.GetPosition(LeftMarker).X, 0);
                // var lower = $"LOWER VALUE: {LowerValue:000.0}";
                // var x = $"X: {_leftSliderPoint.X:00.00}";
                // var leftThumb = $"LEFT THUMB: {LeftThumbMargin.Left:000.0}";
                // var lowM = $"LOW-: {LowerValue + _leftSliderPoint.X}";
                // var lowP = $"LOW+: {LowerValue + _leftSliderPoint.X}";
                // var result = LowerValue + _leftSliderPoint.X < Minimum || LowerValue + _leftSliderPoint.X > UpperValue;
                // Debug.WriteLine($"{lower} | {x} | {leftThumb} | {lowM} | {lowP} | {result}");
                if(_leftSliderPoint < 0 || _leftSliderPoint > Track.Width) return;
                LowerValue = Math.Round(_leftSliderPoint / Track.Width * Maximum, 0);
                Debug.WriteLine(LowerValue);
            }
